...
DESKTOPCODE='../../../application/client/desktop/demo123_5799'
DESKTOPIMAGENAME='geppettotest/demo123_5799-desktop:1.0'
...
helm install --name demo123_5799 ./helm
if [ $? -eq 0 ]; then
